    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+94 71 234 5678</p>
                <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@hellomachan.com</p>
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="{{ route('home') }}">Hello Machan</a>, All Right Reserved.
                </div>
